...
public class PersonServiceUnitTest {
    ...
    @Test
    public void whenNotFindByName_thenReturnPerson() {
        // given
        Person leo = new Person("leo", "leeeo");
        entityManager.persist(leo);
        entityManager.flush();

        // when
        Person found = personRepository.findByName(leo.getName());

        // then
        assertThat(found.getName())
                .isNotEqualTo(leo.getName());
